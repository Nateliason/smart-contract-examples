...
// This is a contract for rewarding people for staking tokens. 
// Great for incentivizing a liquidity program, where the staked token is the LP token from Sushi etc. 
...
contract LPStaking is Ownable, ReentrancyGuard, Pausable { 
  ...
  constructor(address _stakingToken, address _rewardToken) {
    ...
    dailyEmissionsRate = 13698000000000000000000; // daily emissions for a 20m supply over 4 years
