...
// This is a more advanced version of the staking contract that makes users lock up their tokens for various durations
// Great for incentivizing people to lock their governance tokens in exchange for rewards
...
contract StakingLocking is Ownable, ReentrancyGuard, Pausable { 
